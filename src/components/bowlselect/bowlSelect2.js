        ...
        return(
            ...
            <div className="mainWrapForSect">
                ...
                <div className="circle updatetCircle">
                    <Summary/>
                   <Link to="/bowlselect1"><img className="prevBtn" src="./images/prevBtn.png"/></Link>
                   <img onClick={this.cl.bind(this)} className="ordsm" src="./images/ordsm.png"></img>
                    ...
                    <div className="textArea updatetTextarea"><p>Select your</p> <span>sauce</span></div>
                </div> 
                ...
                <div className="under-sect plpops">
                    ...
                    <i onClick={this.hdl} style={{position:"absolute", top:"-125px", left:"330px", transform:"rotate(-65deg)", color:"#ef5757",cursor:"pointer"}} className="fa fa-chevron-right fa-2x"></i>
                    {
                        this.props.data.saucesTypes.map((item , index1) => {
                           return  <Plcomponent type='sauce' fun={this.check(item)} info = {item} key= {index1-10} id={index1-10}/>
                        })
                    }
                    {
                        this.props.data.saucesTypes.map((item , index1) => {
                           return  <Plcomponent type='sauce' fun={this.check(item)} info = {item} key= {index1-5} id={index1-5}/>
                        })
                    }
                    {
                        this.props.data.saucesTypes.map((item , index1) => {
                           return  <Plcomponent type='sauce' fun={this.check(item)} info = {item} key= {index1} id={index1}/>
                        })
                    }
                    {
                        this.props.data.saucesTypes.map((item , index1) => {
                ...
                <Link to="/bowlselect3" className="nextBtn wtCart">Next</Link>
